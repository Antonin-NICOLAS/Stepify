...
const Email2FACodeTemplate = (token, lang) => {
  const template = `
<!DOCTYPE html>
<html
                              ...
                              <tr>
                                ...
                                >
                                  <div class="alignment" align="center">
                                    ...
                                    >
                                      <img
                                        src="https://res.cloudinary.com/dpqhhckyj/image/upload/v1749615117/code_okrdwu.png"
                                        style="
                                          display: block;
                                          height: auto;
                                          border: 0;
                            ...
                            >
                              <tr>
                                ...
                                >
                                  ...
                                  >
                                    <p style="margin: 0">
                                      ${t('email2FAcode.hello', lang)}
                                    </p>
                                    <p style="margin: 0">
                                      ${t('email2FAcode.intro', lang)}
                                    </p>
                                  </div>
                                </td>
                              </tr>
                                    ...
                                    >
                                      ...
                                      >
                                        ...
                                        <p
                                          ...
                                          "
                                        >
                                          ${t('email2FAcode.expiration', lang)}
                                        </p>
                                      </div>
                                    </div>
                                  </div>
                            ...
                            >
                              <tr>
                                ...
                                >
                                  ...
                                  >
                                    <p style="margin: 0">
                                    ${t('email2FAcode.note', lang)}
                                    </p>
                                    <p style="margin: 0">
                                    ${t('email2FAcode.ignore', lang)}
                                    </p>
                                    <p style="margin: 0">
                                        ${t('email2FAcode.bye', lang)}
                                    </p>
                                    <p style="margin: 0">
                                    ${t('email2FAcode.team_signature', lang)}
                                    </p>
                                  </div>
                                </td>
                              </tr>
                                ...
                                <td class="pad" style="width: 100%">
                                  <div class="alignment" align="center">
                                    <div style="max-width: 640px">
                                      <img
                                        src="https://github.com/Antonin-NICOLAS/Stepify/blob/main/frontend/src/assets/logo.png?raw=true"
                                        style="
                                          display: block;
                                          height: auto;
                                          border: 0;
