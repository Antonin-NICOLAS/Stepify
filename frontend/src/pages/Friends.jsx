          ...
          <div className="friends-content">
            ...
            {friends.length > 0 ? (
                  ...
                  return (
                    ...
                    >
                      <div className="friend-avatar">
                        ...
                        />
                        <div
                          className={`activity-indicator status-${activity.status}`}
                        ></div>
                      </div>
                      ...
                      <div className="friend-info">
                        ...
                        <div className="friend-stats">
                          ...
                          <div className="stat">
                            <Spline size={12} />
                            <span>
                              {(friend.userId.totalDistance || 0).toFixed(1)} km
                            </span>
                          </div>
                          <div className="stat">
                            <Trophy size={12} />
                        ...
                        <div className="friend-meta">
                          ...
                          <div className="added-date">
                            Ami depuis le {formatDate(friend.addedAt)}
                          </div>
                        </div>
                      </div>
              ...
              <div className="empty-friends">
                ...
                <p>
                  Commencez à ajouter des amis pour voir leurs activités et vous
                    ...
                    <div key={request._id} className="request-card received">
                      ...
                      <div className="request-actions">
                        <button
                          className="action-button primary"
                          onClick={() =>
                            handleAcceptRequest(request.sender._id, request._id)
                          }
                        >
                          <Check size={16} />
                          <span>Accepter</span>
            ...
            <div className="search-results">
              {searchQuery.trim() === '' ? (
                <div className="empty-search">
                  ...
                  <p>
                    Tapez un nom d'utilisateur ou un nom pour commencer votre
                    recherche.
                  </p>
                </div>
                      ...
                      <div className="result-actions">
                        {friends.some(
                          ...
                          <button
                            className="action-button primary"
                            onClick={() =>
                              handleSendFriendRequest(searchUser._id)
                            }
                          >
                            <UserPlus size={16} />
                            <span>Ajouter</span>
        ...
        return (
          <div className="settings-content">
            <div className="settings-header">
              ...
              <p>
                Gérez vos préférences de confidentialité et d'interaction avec
                vos amis
              </p>
            </div>
              ...
              <div className="settings-section">
                ...
                <div className="setting-item">
                  <div className="setting-info">
                    ...
                    <p>
                      Permettre à vos amis de voir vos statistiques détaillées
                    </p>
                  </div>
                  <label className="toggle-switch">
                    <input
                      ...
                      onChange={(e) =>
                        setSettings({
                          ...settings,
                          showStatsToFriends: e.target.checked,
                        })
                      }
                    />
                    <span className="toggle-slider"></span>
            ...
            <div className="friend-detail-content">
              <div className="friend-detail-header">
                <div className="friend-detail-avatar">
                  ...
                  />
                  <div
                    className={`activity-indicator status-${
                      getActivityStatus(selectedFriend).status
                    }`}
                  ></div>
                </div>
              ...
              <div className="friend-detail-stats">
                ...
                <div className="stat-card">
                  ...
                  <div className="stat-content">
                    <span className="stat-value">
                      {(selectedFriend.totalDistance || 0).toFixed(1)} km
                    </span>
                ...
                <div className="stat-card">
                  ...
                  <div className="stat-content">
                    <span className="stat-value">
                      {selectedFriend.streak?.current || 0}
                    </span>
