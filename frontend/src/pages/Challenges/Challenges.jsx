...
const Challenges = () => {
  ...
  const ActivityOptions = [
    { value: 'steps', label: ' Pas', icon: <Footprints size={16} /> },
    {
      value: 'steps-time',
      label: ' Pas par jour',
      icon: <Icon iconNode={sneaker} size={16} />,
    },
    ...
    { value: 'calories', label: ' Calories (kcal)', icon: <Flame size={16} /> },
    {
      ...
      icon: <Icon iconNode={watchActivity} size={16} />,
    },
    {
      value: 'any',
      label: " Tout type d'activité",
    ...
    return (
      <div
        ...
        className={`activity-select__option ${
          isSelected ? 'activity-select__option--is-selected' : ''
        } ${isFocused ? 'activity-select__option--is-focused' : ''}`}
        style={{
          display: 'flex',
          alignItems: 'center',
          gap: '0.5rem',
            ...
            {filteredChallenges.length > 0 ? (
                  ...
                  >
                    ...
                    <div className="challenge-progress-section">
                      <div className="progress-header">
                        ...
                        <span>
                          {computeGlobalProgress(challenge.participants)}%
                        </span>
                      </div>
                      ...
                      {challenge.creator._id === user?._id &&
                        challenge.status !== 'completed' && (
                          <button
                            ...
                            disabled={
                              challenge.status === 'completed' || isLoading
                            }
                          >
                            <X size={16} />
                            <span>Supprimer</span>
              ...
              <div className="no-challenges">
                <div className="no-data-message">
                  ...
                  <p>
                    Vous n'avez pas encore rejoint de défis ou aucun défi ne
                  ...
                  >
                    ...
                    <div className="challenge-creator">
                      ...
                      <div className="creator-info">
                        <img
                          src={
                            challenge.creator.avatarUrl || '/placeholder.svg'
                          }
            ...
            {challengeNotifications && challengeNotifications.length > 0 ? (
                  ...
                  <div key={invitation?._id} className="invitation-card">
                    <div className="invitation-header">
                      <div className="invitation-title">
                        <h3>
                          {invitation?.challenge.name[user?.languagePreference]}
                        </h3>
                        {new Date(invitation?.DeleteAt) <
                          new Date(Date.now() + 24 * 60 * 60 * 1000) && (
                      ...
                      <p className="invitation-description">
                        {invitation?.content[user?.languagePreference]}
                      </p>
                    </div>
                    ...
                    <div className="invitation-details">
                      ...
                      <div className="invitation-meta">
                        ...
                        <div className="invitation-expiry">
                          ...
                          <span className="detail-value">
                            {formatDate(invitation?.DeleteAt)}
                          </span>
                        </div>
                    ...
                    <div className="invitation-actions">
                      <button
                        className="action-button primary"
                        onClick={() =>
                          handleRespondToInvitation(invitation._id, 'accept')
                        }
                      >
                        <Check size={16} />
                        <span>Accepter</span>
                      ...
                      <button
                        className="action-button secondary"
                        onClick={() =>
                          handleRespondToInvitation(invitation._id, 'decline')
                        }
                      >
                        <X size={16} />
                        <span>Refuser</span>
              ...
              <div className="no-invitations">
                <div className="no-data-message">
                  ...
                  <p>
                    Vous n'avez pas d'invitations à des défis pour le moment.
                  </p>
                </div>
              </div>
            )}
                    ...
                    <div className="form-group">
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          setNewChallenge({
                            ...newChallenge,
                            goal: Number.parseInt(e.target.value),
                          })
                        }
                        required
                      />
                    ...
                    <div className="form-group">
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          setNewChallenge({
                            ...newChallenge,
                            xpReward: Number.parseInt(e.target.value),
                          })
                        }
                        min={10}
                        step={5}
                  ...
                  <div className="form-group">
                    <div className="toggle-group">
                      <label htmlFor="is-private">
                        {newChallenge.isPrivate ? 'Défi privé' : 'Défi public'}
                      </label>
                    ...
                    <div className="form-group">
                      ...
                      <div className="friends-selection">
                        {user?.friends.length === 0 ? (
                          <p className="form-help-text">
                            Vous navez pas d'ami. Vous pouvez créer le
                            challenge. Si dans une semaine vous êtes le seul
                          ...
                          user?.friends.slice(0, 5).map((friend) => (
                            ...
                            >
                              ...
                              />
                              <label
                                htmlFor={`friend-${friend.userId._id}`}
                                className="friend-label"
                              >
                                <img
                                  src={
                                    friend.userId.avatarUrl ||
                                    '/placeholder.svg'
                                  }
          ...
          <div className="modal join-challenge-modal">
            ...
            <div className="join-challenge-content">
              <p className="join-instructions">
                Entrez le code d'accès du défi privé que vous souhaitez
                rejoindre.
              </p>
            ...
            <div className="create-challenge-content">
              ...
              >
                <div className="form-section">
                  ...
                  <div className="form-group">
                    <label htmlFor="modal-challenge-description">
                      Description
                    </label>
                    <textarea
                ...
                <div className="form-section">
                  ...
                  <div className="form-row">
                    ...
                    <div className="form-group">
                      <label htmlFor="modal-goal-value">
