...
// icons
import { Icon, Footprints, Spline, Watch, Flame, Activity, Trophy, Calendar, Zap, Check, X, Lock, Unlock, CalendarIcon, Users, Clock, Hash, Crown, Medal, Award, Share2, UserPlus, MessageSquare } from "lucide-react"
                                ...
                                <div className="participants-list">
                                    {challenge.participants.slice(0, 10).map((participant, index) => (
                                        <div
                                            ...
                                            className={`participant-item ${participant.userId === user?._id ? "current-user" : ""
                                                }`}
                                        >
                                            ...
                                            <div className="participant-progress-container">
                                                <div className="participant-value">
                                                    {formatgoal(participant.goal, challenge.activityType)}
                                                </div>
                                                <div className="progress-container">
                                                    <div
                                                        className="progress-bar"
                                    ...
                                    {challenge.participants.length > 10 && (
                                        <button className="show-more-button">
                                            Voir tous les participants ({challenge.participants.length})
                                        </button>
                                    )}
                                </div>
                            </div>
